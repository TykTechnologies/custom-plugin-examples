...
Golang	| 	Post + Auth	 | 	Dummy one to test the 2 hooks in go	                       |	[Link](plugins/go-post-inject_metadata)
Golang	| 	Post 	     | 	Injects Key Meta Data into a Header	                       |	[Link](plugins/go-auth-multiple_hook_example)
